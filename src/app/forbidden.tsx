...
export default function ForbiddenPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.12),transparent_30%),linear-gradient(180deg,var(--background),color-mix(in_oklch,var(--background)_88%,white))] px-4 py-10 text-foreground sm:px-6 lg:px-8">
        ...
        <Card className="w-full border-border/60 bg-card/95 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
          <CardHeader className="space-y-3">
            ...
            <CardDescription className="max-w-2xl text-base leading-7 text-brand-muted">
              You are signed in, but your account does not have permission to view this resource. Each workspace is limited to the role assigned to your account.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="rounded-2xl border border-border/70 bg-muted/40 p-4 text-sm text-brand-muted">
              If this looks wrong, contact your school administrator to confirm your role, school membership, or access grant.
            </div>
