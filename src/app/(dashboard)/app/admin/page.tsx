...
const curriculumRows = [
  ["Mathematics", "14 offerings", "6 teachers"],
  ["Science", "11 offerings", "5 teachers"],
  ["English", "15 offerings", "7 teachers"],
  ["ICT", "9 offerings", "4 teachers"],
];
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-6 py-10">
      ...
      <p className="mt-2 text-(--brand-muted)">
        Manage school setup, users, permissions, and high-level reports.
      </p>
    </main>
  );
}
