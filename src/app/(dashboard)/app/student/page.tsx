...
export default function StudentDashboardPage() {
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.85fr)]">
        <Tabs defaultValue="snapshot" className="gap-4">
          <TabsList className="w-full justify-start gap-1 rounded-2xl border border-border/70 bg-card/90 p-1">
            <TabsTrigger value="snapshot" className="rounded-xl px-4 py-2">
            ...
            <TabsTrigger value="grades" className="rounded-xl px-4 py-2">
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-6 py-10">
      <h1 className="text-3xl font-bold text-(--brand-ink)">Student Dashboard</h1>
      <p className="mt-2 text-(--brand-muted)">
        View your attendance, grades, assessments, and personal academic summary.
      </p>
    </main>
  );
}
