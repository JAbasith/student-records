...
export default async function TeacherDashboardPage() {
  ...
  await requireDashboardRole(supabase, "teacher");
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.85fr)]">
        <Tabs defaultValue="today" className="gap-4">
          <TabsList className="flex w-full flex-nowrap justify-start gap-1 overflow-x-auto rounded-2xl border border-border/70 bg-card/90 p-1">
            <TabsTrigger value="today" className="shrink-0 rounded-xl px-4 py-2">
              <CalendarDays className="size-4" />
              Today
            </TabsTrigger>
            <TabsTrigger value="assessments" className="shrink-0 rounded-xl px-4 py-2">
